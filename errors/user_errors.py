...
USER_IS_NOT_WORKING_ERROR = HTTPException(status_code=status.HTTP_403_FORBIDDEN,
                                          detail='User Is Not Working.')
...
PIC_NOT_FOUND_ERROR = HTTPException(status_code=status.HTTP_204_NO_CONTENT,
