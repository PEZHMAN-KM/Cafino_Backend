...
from dependencies.access_dependencies import USER_DEPENDENCY, SUPER_ADMIN_DEPENDENCY
from schemas.user_schemas import UserDisplay, UserModel
from functions import user_functions


router = APIRouter(
    prefix='/super_admin/super_admin',
    tags=['Super Admin Super Admin'],
)
...
async def super_admin_unemploy_user(user_id: NAME_BODY, db: DB_DEPENDENCY, user: SUPER_ADMIN_DEPENDENCY):
